      ...
      <div className="my-10 max-w-[1440px] mx-auto">
        <div className="flex flex-col gap-4 my-7 ">
            <div className="flex flex-col gap-3">
                ...
                <input className='text-3xl border outline-none p-2' type="text"
              ...
              <div className="flex flex-col gap-10 ">
                <div className="flex flex-col gap-3 ">
                  ...
                  <input type="file" name="" id=""                     
                    ...
                    <button className="cursor-pointer w-fit text-black transition-all bg-white py-2 px-4 border rounded-sm hover:text-white hover:bg-[#323232] " onClick={handleImage}>
            Keep Original Image
          </button>
                </div>
              </div>
              <div className="min-w-[300px] max-w-[300px] aspect-[5/3] bg-gray-50 mt-10 md:mt-0">
                <img className='w-full h-full object-cover' src={file == null ? post?.src : temporyImageView && temporyImageView } alt="" />
              </div>
            </div>
        ...
        <div className="flex flex-col ">
          {post && (
            ...
            <Editor setBody={setBody} body={post.body}/>
          )}
        </div>
        <div className="mt-10">
          {reqProcessing ? (
          ...
          <button className="_btn_1 w-fit cursor-pointer">
            ...
            <button className="_btn_1 w-fit cursor-pointer" onClick={updatePost}>Update</button>
          )}
        </div>
      </div>
      </div>
